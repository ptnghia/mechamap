...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'auth.providers.admin-users.driver' => 'string',
            'auth.providers.admin-users.model' => 'string',
            ...
            'filesystems.links.D:\xampp\htdocs\laravel\mechamap_backend\public\storage' => 'string',
...
'moderate-content','flag-thread','flag-comment','mark-solution','bump-thread',
...
'auth.providers.users.model','auth.providers.admin-users.driver','auth.providers.admin-users.model','auth.passwords.users.provider','auth.passwords.users.table',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links.D:\\xampp\\htdocs\\laravel\\mechamap_backend\\public\\storage','logging.default','logging.deprecations.channel',
...
'signed','throttle','verified','admin','admin.auth',
'verified.social','track.activity','forum.cache',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','ignition.healthCheck','ignition.executeSolution','ignition.updateConfig',
'home','api.threads','dashboard','users.index','profile.show',
'profile.activities','profile.edit','profile.update','profile.destroy','profile.avatar.update',
'profile.follow','profile.unfollow','profile.posts.store','threads.bookmark.add','threads.bookmark.remove',
'threads.follow.add','threads.follow.remove','following.index','following.followers','following.threads',
'following.participated','alerts.index','alerts.read','alerts.destroy','alerts.read-all',
'conversations.index','conversations.show','conversations.store','conversations.messages.store','bookmarks.index',
'bookmarks.store','bookmarks.destroy','showcase.index','showcase.create','showcase.store',
'showcase.show','showcase.edit','showcase.update','showcase.destroy','showcase.upload.temp',
'showcase.comment','showcase.comment.delete','showcase.toggle-like','showcase.toggle-follow','showcase.bookmark',
'showcase.download','showcase.attach-to-thread','business.index','business.services','subscription.index',
'subscription.store','subscription.success','subscription.cancel','new','forums.index',
'forums.search','forums.show','threads.index','threads.create','threads.store',
'threads.show','threads.edit','threads.update','threads.destroy','browse.threads.index',
'browse.threads.top-rated','browse.threads.trending','browse.threads.by-tag','browse.threads.by-forum','browse.threads.search',
'user.dashboard','user.bookmarks','user.bookmarks.search','user.bookmarks.folders.create','user.bookmarks.folders.update',
'user.bookmarks.folders.delete','user.ratings','user.my-threads','user.activity','user.settings',
'user.settings.profile','user.settings.password','user.settings.preferences','user.settings.notifications','user.settings.privacy',
'user.settings.delete-account','threads.rate','threads.rate.update','threads.rate.remove','whats-new','showcase.public','gallery.index','search.index','search.advanced',
'search.advanced.submit','search.ajax','members.index','members.online','members.staff',
'members.leaderboard','faq.index','theme.dark-mode','theme.original-view','categories.show',
'forums.select','forums.select.submit','gallery.create','gallery.store','gallery.destroy',
'gallery.show','admin.login','admin.login.submit','admin.logout','admin.dashboard',
'admin.profile.index','admin.profile.update','admin.profile.password','admin.profile.password.update','admin.users.index',
'admin.users.create','admin.users.store','admin.users.admins','admin.users.admins.create','admin.users.admins.store',
'admin.users.admins.edit','admin.users.admins.update','admin.users.admins.permissions','admin.users.admins.permissions.update','admin.users.members',
'admin.users.members.export','admin.users.members.create','admin.users.members.store','admin.users.members.show','admin.users.members.edit',
'admin.users.members.update','admin.users.admins.export','admin.users.show','admin.users.edit','admin.users.update',
'admin.users.reset-password','admin.users.destroy','admin.users.toggle-ban','admin.users.bulk-action','admin.users.toggle-status',
'admin.threads.index','admin.threads.create','admin.threads.store','admin.threads.show','admin.threads.edit',
'admin.threads.update','admin.threads.destroy','admin.threads.approve','admin.threads.reject','admin.threads.statistics',
'admin.moderation.index','admin.moderation.dashboard','admin.moderation.threads','admin.moderation.threads.approve','admin.moderation.threads.reject',
'admin.moderation.threads.flag','admin.moderation.threads.bulk-action','admin.moderation.comments','admin.moderation.comments.approve','admin.moderation.comments.reject',
'admin.moderation.comments.flag','admin.moderation.comments.bulk-action','admin.moderation.statistics','admin.moderation.user-activity','admin.moderation.threads.quick-action',
'admin.moderation.comments.quick-action','admin.categories.index','admin.categories.create','admin.categories.store','admin.categories.show',
'admin.categories.edit','admin.categories.update','admin.categories.destroy','admin.categories.reorder','admin.forums.index',
'admin.forums.create','admin.forums.store','admin.forums.show','admin.forums.edit','admin.forums.update',
'admin.forums.destroy','admin.forums.reorder','admin.comments.index','admin.comments.create','admin.comments.store',
'admin.comments.show','admin.comments.edit','admin.comments.update','admin.comments.destroy','admin.comments.toggle-visibility',
'admin.comments.toggle-flag','admin.comments.statistics','admin.statistics.index','admin.statistics.users','admin.statistics.content',
'admin.statistics.interactions','admin.statistics.export','admin.pages.index','admin.pages.create','admin.pages.store',
'admin.pages.show','admin.pages.edit','admin.pages.update','admin.pages.destroy','admin.page-categories.index',
'admin.page-categories.create','admin.page-categories.store','admin.page-categories.show','admin.page-categories.edit','admin.page-categories.update',
'admin.page-categories.destroy','admin.page-categories.reorder','admin.faqs.index','admin.faqs.create','admin.faqs.store',
'admin.faqs.show','admin.faqs.edit','admin.faqs.update','admin.faqs.destroy','admin.faqs.toggle-status',
'admin.faq-categories.index','admin.faq-categories.create','admin.faq-categories.store','admin.faq-categories.show','admin.faq-categories.edit',
'admin.faq-categories.update','admin.faq-categories.destroy','admin.faq-categories.toggle-status','admin.faq-categories.reorder','admin.media.index',
'admin.media.create','admin.media.store','admin.media.show','admin.media.edit','admin.media.update',
'admin.media.destroy','admin.media.download','admin.media.library','admin.settings.index','admin.settings.general',
'admin.settings.update-general','admin.settings.company','admin.settings.update-company','admin.settings.contact','admin.settings.update-contact',
'admin.settings.social','admin.settings.update-social','admin.settings.api','admin.settings.update-api','admin.settings.copyright',
'admin.settings.update-copyright','admin.settings.forum','admin.settings.update-forum','admin.settings.user','admin.settings.update-user',
'admin.settings.email','admin.settings.email.update','admin.settings.email.test-connection','admin.settings.security','admin.settings.security.update',
'admin.settings.wiki','admin.settings.wiki.update','admin.showcases.index','admin.showcases.create','admin.showcases.store',
'admin.showcases.show','admin.showcases.edit','admin.showcases.update','admin.showcases.destroy','admin.showcases.toggle-featured',
'admin.showcases.toggle-active','admin.showcases.update-order','admin.showcases.bulk-action','admin.search.index','admin.search.settings.update',
'admin.search.reindex','admin.search.reindex.perform','admin.search.statistics','admin.search.test','admin.search.test.perform',
'admin.search.optimize','admin.search.clear-cache','admin.search.export-statistics','admin.search.rebuild-suggestions','admin.search.analytics',
'admin.search.analytics.api','admin.search.analytics.recent','admin.search.analytics.export','admin.search.log','admin.search.test.api',
'admin.alerts.index','admin.alerts.settings.update','admin.alerts.test','admin.alerts.test.send','admin.alerts.statistics',
'admin.alerts.cleanup','admin.alerts.export-statistics','admin.messages.index','admin.messages.settings.update','admin.messages.conversations',
'admin.messages.conversations.show','admin.messages.conversations.destroy','admin.messages.statistics','admin.messages.cleanup','admin.messages.export-statistics',
'admin.seo.index','admin.seo.general.update','admin.seo.robots','admin.seo.robots.update','admin.seo.sitemap',
'admin.seo.sitemap.generate','admin.seo.sitemap.delete','admin.seo.social','admin.seo.social.update','admin.seo.advanced',
'admin.seo.advanced.update','admin.seo.analytics','admin.seo.audit','admin.seo.submit-sitemap','admin.seo.check-indexing',
'auth.socialite','threads.comments.store','comments.update','comments.destroy',
'comments.like','threads.like','threads.save','threads.saved','threads.polls.store',
'polls.vote','admin.moderation.comments.delete','about','rules','help.writing-guide',
'contact','contact.support','whats-new.popular','whats-new.threads','whats-new.media',
'whats-new.replies','whats-new.showcases','register','login','password.request','password.email','ajax.login','ajax.register',
'ajax.forgot-password','password.reset','password.store','verification.notice','verification.verify',
'verification.send','password.confirm','password.update','logout',);
        registerArgumentsSet('views', 
'admin.alerts.index','admin.auth.login','admin.categories.create','admin.categories.edit','admin.categories.index',
'admin.categories.show','admin.comments.edit','admin.comments.index','admin.comments.show','admin.comments.statistics',
'admin.dashboard','admin.faq-categories.create','admin.faq-categories.edit','admin.faq-categories.index','admin.faqs.create',
'admin.faqs.edit','admin.faqs.index','admin.forums.create','admin.forums.edit','admin.forums.index',
'admin.forums.show','admin.layouts.app','admin.layouts.partials.alerts','admin.layouts.partials.breadcrumb','admin.layouts.partials.footer',
'admin.layouts.partials.header','admin.layouts.partials.meta','admin.layouts.partials.scripts','admin.layouts.partials.sidebar','admin.layouts.partials.styles',
'admin.media.create','admin.media.edit','admin.media.index','admin.media.show','admin.messages.index',
'admin.moderation.comments','admin.moderation.dashboard','admin.moderation.partials.comment-details','admin.moderation.partials.thread-details','admin.moderation.threads',
'admin.page-categories.create','admin.page-categories.edit','admin.page-categories.index','admin.page-seo.create','admin.page-seo.edit',
'admin.page-seo.index','admin.pages.create','admin.pages.edit','admin.pages.index','admin.pages.show',
'admin.profile.index','admin.profile.password','admin.search.analytics','admin.search.index','admin.search.reindex',
'admin.seo.advanced','admin.seo.index','admin.seo.robots','admin.seo.sitemap','admin.seo.social',
'admin.settings.api','admin.settings.company','admin.settings.contact','admin.settings.copyright','admin.settings.email',
'admin.settings.forum','admin.settings.general','admin.settings.partials.sidebar','admin.settings.security','admin.settings.social',
'admin.settings.user','admin.settings.wiki','admin.showcases.create','admin.showcases.index','admin.statistics.content',
'admin.statistics.index','admin.statistics.interactions','admin.statistics.users','admin.threads.create','admin.threads.edit',
'admin.threads.index','admin.threads.show','admin.threads.statistics','admin.users.admins.create','admin.users.admins.edit',
'admin.users.admins.index','admin.users.admins.permissions','admin.users.create','admin.users.edit','admin.users.index',
'admin.users.members.index','admin.users.show','alerts.index','auth.confirm-password','auth.forgot-password',
'auth.login','auth.register','auth.reset-password','auth.verify-email','bookmarks.index',
'business.index','business.services','categories.show','components.application-logo','components.auth-session-status',
...
'components.showcase-card','components.showcase-image','components.sidebar','components.sidebar-professional','components.text-input',
'components.thread-creation-sidebar','components.ui.accordion','components.ui.dropdown','components.ui.icon','components.ui.modal',
'components.ui.notification','conversations.index','conversations.show','dashboard','emails.welcome-social-user',
'faq.index','following.followers','following.index','following.participated','following.threads',
'forums.index','forums.search','forums.select','forums.show','gallery.create',
'gallery.index','gallery.show','home','layouts.app','layouts.auth',
'layouts.guest','layouts.navigation','members.index','members.leaderboard','members.online',
'members.staff','new-content.index','new-content.whats-new','pages.about','pages.contact',
'pages.rules','pages.writing-guide','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default',
...
'pagination::tailwind','partials.thread-item','profile.activities','profile.edit','profile.index',
'profile.partials.about-section','profile.partials.activity-section','profile.partials.delete-user-form','profile.partials.profile-posts-section','profile.partials.update-password-form',
'profile.partials.update-profile-information-form','profile.show','profile.show-skyscraper','search.advanced','search.advanced-results',
'search.index','showcase.create','showcase.index','showcase.public','showcase.show',
'subscription.cancel','subscription.index','subscription.success','test.thread-actions','threads.create',
'threads.edit','threads.index','threads.partials.poll','threads.saved','threads.show',
'user.bookmarks','user.dashboard','user.settings','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5',
...
'vendor.pagination.simple-tailwind','vendor.pagination.tailwind','welcome','whats-new.index','whats-new.media',
'whats-new.popular','whats-new.replies','whats-new.showcases','whats-new.threads','laravel-exceptions::401',
...
'validation.uuid','validation.custom.attribute-name.rule-name','messages.welcome','messages.success','messages.error',
'messages.menu.home','messages.menu.about','messages.menu.contact','messages.buttons.save','messages.buttons.cancel',
'messages.buttons.edit','messages.buttons.delete','messages.forms.name','messages.forms.email','messages.forms.password',
'messages.forms.confirm_password','messages.new_posts','messages.new_threads','messages.new_media','messages.new_showcases',
'messages.popular','messages.looking_for_replies','messages.thread_status.sticky','messages.thread_status.locked','messages.threads_looking_for_replies',
'messages.started_by','messages.replies','messages.started_by_me','messages.most_replies','messages.popular_threads',
'messages.latest','messages.sort_by','messages.jump_to_latest',);
...
'CORS_ALLOWED_ORIGINS','FRONTEND_URL','SANCTUM_STATEFUL_DOMAINS','SECURE_COOKIES','SESSION_SECURE_COOKIES',
'SESSION_SAME_SITE','MAX_UPLOAD_SIZE','ALLOWED_FILE_TYPES','THREADS_PER_PAGE','COMMENTS_PER_PAGE',
'SEARCH_RESULTS_PER_PAGE','MAX_THREAD_TITLE_LENGTH','MAX_COMMENT_LENGTH','SITE_META_DESCRIPTION','SITE_META_KEYWORDS',
'GOOGLE_ANALYTICS_ID','GOOGLE_SITE_VERIFICATION','RATE_LIMIT_API','RATE_LIMIT_LOGIN','OPCACHE_ENABLED',
'PHP_MEMORY_LIMIT',);
