...
return [
    ...
    'search' => [
        ...
        'no_results_message' => 'Chúng tôi không thể tìm thấy bất kỳ chủ đề hoặc bài viết nào phù hợp với',
        'no_threads_in_category' => 'Không có chủ đề nào trong :category phù hợp với',

        // Search tips
        'search_tips' => 'Mẹo tìm kiếm',
        'tip_quotes' => 'Sử dụng dấu ngoặc kép cho cụm từ chính xác',
        'tip_multiple_words' => 'Nhiều từ sẽ tìm kiếm chủ đề chứa tất cả các từ',
        'tip_minimum_chars' => 'Tối thiểu 3 ký tự cần thiết để tìm kiếm',
        'tip_browse_categories' => 'Duyệt danh mục để tìm chủ đề cụ thể hơn',

        // Suggestions
        'suggestions' => 'Hãy thử',
        'check_spelling' => 'Kiểm tra chính tả',
        'use_general_keywords' => 'Sử dụng từ khóa tổng quát hơn',
        'try_different_keywords' => 'Thử các từ khóa khác',
        'browse_forum_categories' => 'Duyệt qua các danh mục forum',
