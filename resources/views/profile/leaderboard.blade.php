...
<div class="body_page">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="div_title_page">
            <h1 class="h2 mb-1 title_page">{{ seo_title_short(__('ui.leaderboard.title')) }}</h1>
            <p class="text-muted mb-0">{{ seo_value('description', '')  }}</p>
        </div>
        <a href="{{ route('users.index') }}" class="btn btn-outline-secondary border-primary text-primary">
    ...
    <ul class="nav nav-pills nav-fill mb-3 tab_mechamap">
        <li class="nav-item">
            <a class="nav-link active" data-bs-toggle="tab" href="#top-posters">
                <i class="fas fa-comment me-2"></i> {{ __('ui.leaderboard.top_posts') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#top-thread-creators">
                <i class="fas fa-file-alt me-2"></i> {{ __('ui.leaderboard.top_threads') }}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#top-followed">
                <i class="fas fa-users me-2"></i> {{ __('ui.leaderboard.top_followed') }}
            </a>
        </li>
    </ul>
                    ...
                    @forelse($topPosters as $index => $user)
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <img src="{{ $user->getAvatarUrl() }}" alt="{{ $user->name }}" class="rounded-circle me-3" width="48" height="48" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                <div>
                                    <h6 class="mb-1">
                        ...
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <img src="{{ $user->getAvatarUrl() }}" alt="{{ $user->name }}"
                                        class="rounded-circle me-3" width="48" height="48" onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
                                <div>
                                    <h6 class="mb-1">
