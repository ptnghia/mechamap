                ...
                <div class="tab-pane fade show active" id="conversations" role="tabpanel">
                    <div class="conversations-search p-2">
                        <input type="text" class="form-control form-control-sm"
                               id="conversationSearch" placeholder="{{ t_ui('ui/forms.search_conversations_placeholder') }}">
                    </div>
                    ...
                    <div class="chat-input">
                        <form id="messageForm" class="d-flex">
                            ...
                            <input type="text" class="form-control" id="messageInput"
                                   placeholder="{{ t_ui('ui/forms.enter_message_placeholder') }}" disabled>
                ...
                <form id="newChatForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="recipientSearch"
                               placeholder="{{ t_ui('ui/forms.search_members_placeholder') }}">
