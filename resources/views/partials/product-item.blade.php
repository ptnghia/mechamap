    ...
    <div class="product-image-container position-relative">
        ...
        <div class="product-actions">
            <button class="btn btn-sm btn-outline-light wishlist-btn" 
                    ...
                    title="{{ t_ui('buttons.add_to_wishlist') }}">
    ...
    <div class="product-info p-3">
        ...
        <div class="seller-info mb-2">
            <small class="text-muted">
                {{ t_marketplace('labels.by') }}
                <a href="{{ route('marketplace.sellers.show', $product->seller->slug ?? '#') }}" 
                   class="text-decoration-none">
                    {{ $product->seller->user->name ?? $product->seller->name ?? 'N/A' }}
                </a>
            </small>
        </div>
