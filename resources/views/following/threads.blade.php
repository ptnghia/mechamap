                    ...
                    <div class="card shadow-sm rounded-3 mb-4">
                        <div class="card-body">
                            <div class="list-group list-group-flush">
                                ...
                                <a href="{{ route('following.threads') }}" class="list-group-item list-group-item-action active">
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="filtersDropdown">
                                    <li><a class="dropdown-item" href="{{ route('following.threads') }}">{{ __('All Forums') }}</a></li>
                                    <li><hr class="dropdown-divider"></li>
                                    @foreach(App\Models\Forum::all() as $forum)
                                        <li><a class="dropdown-item" href="{{ route('following.threads', ['forum' => $forum->id]) }}">{{ $forum->name }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                        </div>
