            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.settings.update-company') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label for="company_tax_id" class="form-label">{{ 'Mã số thuế' }}</label>
                            ...
                            <div class="col-md-4">
                                <label for="company_registration_number" class="form-label">{{ 'Số đăng ký kinh doanh' }}</label>
                            ...
                            <div class="col-md-4">
                                <label for="company_founded_year" class="form-label">{{ 'Năm thành lập' }}</label>
                        ...
                        <div class="mb-3">
                            <label for="company_description" class="form-label">{{ 'Giới thiệu công ty' }}</label>
