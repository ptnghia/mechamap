            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <!-- Document File -->
                        <div class="mb-3">
                            <label for="document_file" class="form-label">File Tài Liệu <span class="text-danger">*</span></label>
                            ...
                            <div class="form-text">
                                Định dạng hỗ trợ: PDF, Word, Excel, PowerPoint, ZIP, RAR. Kích thước tối đa: 10MB
                            </div>
                            @error('document_file')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
