...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">Thêm Video Mới</h4>
    ...
    <form action="{{ route('admin.knowledge.videos.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('video_type') is-invalid @enderror" 
                                ...
                                <option value="youtube" {{ old('video_type', 'youtube') == 'youtube' ? 'selected' : '' }}>YouTube</option>
                                <option value="vimeo" {{ old('video_type') == 'vimeo' ? 'selected' : '' }}>Vimeo</option>
                                <option value="local" {{ old('video_type') == 'local' ? 'selected' : '' }}>Video nội bộ</option>
                            </select>
                            @error('video_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Mô tả chi tiết về nội dung video...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="videoPreview" class="ratio ratio-16x9" style="display: none;">
                        ...
                        <div id="noPreview" class="text-center py-5">
                            ...
                            <p class="text-muted">Nhập URL video để xem trước</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-save me-1"></i> Lưu Video
                            </button>
