...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Bản quyền</h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">MechaMap</a></li>
                    <li class="breadcrumb-item active">Bản quyền</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">{{ 'Thông tin bản quyền' }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.settings.update-copyright') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">{{ 'Nội dung bản quyền hiển thị ở footer của trang web.' }}</div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <div class="form-text">{{ 'Tên của chủ sở hữu bản quyền.' }}</div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-text">{{ 'Năm bản quyền. Có thể là một năm cụ thể hoặc một khoảng thời gian (ví dụ: 2020-2023).' }}</div>
