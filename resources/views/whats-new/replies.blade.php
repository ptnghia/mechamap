                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination pagination-sm mb-0">
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ route('whats-new.replies', ['page' => $i]) }}">{{ $i }}</a>
                            </li>
                            @endfor
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ route('whats-new.replies', ['page' => $totalPages]) }}">{{ $totalPages }}</a>
                            </li>
                            @endif
                        ...
                        <div class="d-flex">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="thread-excerpt mb-2">
                                    <p class="text-muted small">{{ Str::limit(strip_tags($thread->content), 150) }}</p>
                                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-2 thread-meta">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="{{ route('threads.show', [$thread->slug, 'reply' => 'true']) }}" class="btn btn-sm btn-primary">
