...
@section('title', 'Popular Content - MechaMap')
        ...
        <div class="col-12">
            ...
            <div class="whats-new-tabs mb-4">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('whats-new.popular') }}">Popular</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="timeframe-filter mb-4">
                <div class="btn-group" role="group">
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'day']) }}" class="btn btn-outline-secondary {{ $timeframe == 'day' ? 'active' : '' }}">Today</a>
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'week']) }}" class="btn btn-outline-secondary {{ $timeframe == 'week' ? 'active' : '' }}">This Week</a>
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'month']) }}" class="btn btn-outline-secondary {{ $timeframe == 'month' ? 'active' : '' }}">This Month</a>
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'year']) }}" class="btn btn-outline-secondary {{ $timeframe == 'year' ? 'active' : '' }}">This Year</a>
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'all']) }}" class="btn btn-outline-secondary {{ $timeframe == 'all' ? 'active' : '' }}">All Time</a>
                </div>
            </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination pagination-sm mb-0">
                            ...
                            @if($page > 3)
                            <li class="page-item">
                                <a class="page-link" href="{{ route('whats-new.popular', ['page' => 1, 'timeframe' => $timeframe]) }}">1</a>
                            </li>
                            @endif
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ route('whats-new.popular', ['page' => $i, 'timeframe' => $timeframe]) }}">{{ $i }}</a>
                            </li>
                            @endfor
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ route('whats-new.popular', ['page' => $totalPages, 'timeframe' => $timeframe]) }}">{{ $totalPages }}</a>
                            </li>
                            @endif
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Popular Threads</h5>
                </div>
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-2 thread-meta">
                                    <div>
                                        ...
                                        <span><i class="bi bi-chat"></i> {{ $thread->comment_count }} phản hồi</span>
                                    </div>

                                    <div>
                                        @if($thread->category)
                                            <a href="{{ route('categories.show', $thread->category->slug) }}" class="badge bg-secondary text-decoration-none">{{ $thread->category->name }}</a>
                                        @endif

                                        @if($thread->forum)
                                            <a href="{{ route('forums.show', $thread->forum->slug) }}" class="badge bg-info text-decoration-none">{{ $thread->forum->name }}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
