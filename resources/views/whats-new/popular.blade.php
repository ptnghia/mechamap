...
@section('title', __('messages.popular') . ' - MechaMap')
            ...
            <div class="timeframe-filter mb-4">
                <div class="btn-group" role="group">
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'day']) }}"
                        class="btn btn-outline-secondary {{ $timeframe == 'day' ? 'active' : '' }}">{{ __('messages.today') }}</a>
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'week']) }}"
                        class="btn btn-outline-secondary {{ $timeframe == 'week' ? 'active' : '' }}">{{ __('messages.this_week') }}</a>
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'month']) }}"
                        class="btn btn-outline-secondary {{ $timeframe == 'month' ? 'active' : '' }}">{{ __('messages.this_month') }}</a>
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'year']) }}"
                        class="btn btn-outline-secondary {{ $timeframe == 'year' ? 'active' : '' }}">{{ __('messages.this_year') }}</a>
                    <a href="{{ route('whats-new.popular', ['timeframe' => 'all']) }}"
                        class="btn btn-outline-secondary {{ $timeframe == 'all' ? 'active' : '' }}">{{ __('messages.all_time') }}</a>
                </div>
            </div>
