...
<div class="body_page">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="div_title_page">
            ...
            <p class="text-muted mb-0">{{ seo_value('description', __('ui.whats_new.threads.description'))  }}</p>
        </div>
    ...
    <div class="whats-new-tabs mb-4">
        <ul class="nav nav-pills nav-fill">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{ route('whats-new.threads') }}"><i class="fa-solid fa-rss me-1"></i>{{ __('forum.threads.new') }}</a>
            </li>
            <li class="nav-item">
