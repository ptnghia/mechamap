            ...
            <div class="card shadow-sm rounded-3 mb-4">
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <p>{{ __('Your showcase is a collection of your best content that you want to highlight on your profile. Add your favorite threads, posts, or projects to showcase your contributions.') }}</p>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                                    ...
                                    <div class="card h-100">
                                        <div class="card-body">
                                            @if($item->showcaseable_type === 'App\\Models\\Thread')
                                                <h5 class="card-title">
                                                    ...
                                                    <a href="{{ route('threads.show', $item->showcaseable) }}" class="text-decoration-none">
                                            ...
                                            @elseif($item->showcaseable_type === 'App\\Models\\Post')
                                                <h5 class="card-title">
                                                    ...
                                                    <a href="{{ route('threads.show', $item->showcaseable->thread_id) }}#post-{{ $item->showcaseable->id }}" class="text-decoration-none">
                                            ...
                                            @elseif($item->showcaseable_type === 'App\\Models\\Project')
                                                <h5 class="card-title">
                                                    ...
                                                    <a href="{{ route('projects.show', $item->showcaseable) }}" class="text-decoration-none">
                                                        {{ $item->showcaseable->title }}
                                                    </a>
                                                </h5>
                                                <p class="card-text text-muted">
                                        ...
                                        <div class="card-footer bg-transparent">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <small class="text-muted">{{ __('Added') }} {{ $item->created_at->diffForHumans() }}</small>
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted">{{ __('Add your best content to your showcase to highlight it on your profile.') }}</p>
                        </div>
                    @endif
                </div>
            </div>
