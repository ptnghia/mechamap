    ...
    <div class="row g-3">
            ...
            <div class="card h-100 process-card">
                ...
                <div class="card-footer bg-transparent">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('tools.processes') }}" class="btn btn-sm btn-outline-primary">
        ...
        <div class="col-12">
            <div class="text-center py-5">
                ...
                <a href="{{ route('tools.processes') }}" class="btn btn-primary">
...
function compareProcesses() {
    ...
    const url = new URL('{{ route("tools.processes") }}');
