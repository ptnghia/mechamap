                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form action="{{ route('gallery.index') }}" method="GET" class="d-flex">
                                <input type="text" name="search" class="form-control me-2" placeholder="{{ __('Search gallery...') }}" value="{{ request('search') }}">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex justify-content-md-end mt-3 mt-md-0">
                                <div class="btn-group" role="group">
                                    <a href="{{ route('gallery.index') }}?view=grid" class="btn btn-outline-secondary {{ request('view', 'grid') == 'grid' ? 'active' : '' }}">
                                        <i class="bi bi-grid-3x3-gap"></i>
                                    </a>
                                    <a href="{{ route('gallery.index') }}?view=list" class="btn btn-outline-secondary {{ request('view') == 'list' ? 'active' : '' }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <a href="{{ route('gallery.show', $media) }}">
                                                    <img src="{{ asset('storage/' . $media->file_path) }}" alt="{{ $media->title }}" class="img-fluid rounded">
                                                </a>
                                            </div>
                                            <div class="col-md-10">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div>
                                                        <span class="badge bg-secondary">{{ strtoupper(pathinfo($media->file_name, PATHINFO_EXTENSION)) }}</span>
