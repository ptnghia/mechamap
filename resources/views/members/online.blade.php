...
<div class="body_page">
    <div class="mb-4">
        <h1 class="h2 mb-1 title_page">Danh sách thành viên trực tuyến</h1>
        <p class="mb-0 opacity-90">Xem và tìm kiếm thông tin của các thành viên trên MechaMap đang trực tuyến</p>
    </div>
