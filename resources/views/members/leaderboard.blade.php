...
@section('title', t_common("members.leaderboard_title"))
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                        ...
                        {{ t_common("members.leaderboard_title") }}
                    </h4>
                    <p class="mb-0 mt-2 opacity-75">{{ t_common("members.leaderboard_description") }}</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!-- Top Posters -->
