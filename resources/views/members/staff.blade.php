...
@section('title', __('messages.members.staff_title'))
...
<div class="body_page">
     <div class="mb-4">
        <h1 class="h2 mb-1 title_page">{{ __('messages.members.staff_title') }}</h1>
        <p class="mb-0 opacity-90">{{ __('messages.members.staff_description') }}</p>
    </div>
    <div class="card shadow-sm rounded-3">
        ...
        <div class="card-body">
            <!-- Administrators -->
            <h4 class="mb-3 title_page_sub">{{ __('messages.members.administrators') }}</h4>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 item_member_grid">
                                <div class="card-body text-center">
                                    ...
                                    <span class="badge bg-danger mb-2">{{ __('messages.members.administrator') }}</span>

                                    @if($admin->isOnline())
                                        <span class="badge bg-success ms-1">{{ __('messages.members.online') }}</span>
                                    @endif

                                    <p class="small mb-0">{{ $admin->bio ?? __('messages.members.no_bio_available') }}</p>
                                </div>
            ...
            @else
                <div class="alert alert-info mb-5">
                    ...
                    {{ __('messages.members.no_administrators_found') }}
                </div>
            @endif

            <!-- Moderators -->
            <h4 class="mb-3 title_page_sub">{{ __('messages.members.moderators') }}</h4>
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 item_member_grid">
                                <div class="card-body text-center">
                                    ...
                                    <span class="badge bg-primary mb-2">{{ __('messages.members.moderator') }}</span>

                                    @if($moderator->isOnline())
                                        <span class="badge bg-success ms-1">{{ __('messages.members.online') }}</span>
                                    @endif

                                    <p class="small mb-0">{{ $moderator->bio ?? __('messages.members.no_bio_available') }}</p>
                                </div>
                                <div class="card-footer bg-transparent">
                                    <div class="row text-center">
                                        <div class="col-4">
            ...
            @else
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i>
                    {{ __('messages.members.no_moderators_found') }}
                </div>
            @endif
        </div>
    </div>
