        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                <div class="card-body">
                        ...
                        <div class="btn-group">
                            @auth
                                @if($cadFile->canBeDownloaded())
                                    <a href="{{ route('cad.library.download', $cadFile) }}" class="btn btn-primary">
                    ...
                    @if($cadFile->tags)
                        <div class="mb-3">
                            <h6>Tags</h6>
                            @foreach(explode(',', $cadFile->tags) as $tag)
            ...
            @auth
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('cad.library.rate', $cadFile) }}" method="POST">
                            @csrf
                            <div class="mb-3">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Comments ({{ $cadFile->comments->count() }})</h5>
                </div>
                <div class="card-body">
                    @auth
                        <!-- Add Comment Form -->
                    ...
                    <div class="card-body">
                        @foreach($relatedFiles as $related)
                            <div class="d-flex mb-3">
                                ...
                                <div class="flex-grow-1">
                                    <h6 class="mb-1">
                                        <a href="{{ route('cad.library.show', $related) }}" class="text-decoration-none">
