            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card page-card h-100 position-relative">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title"{{ t_content('pages.about_us') }}/h5>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card page-card h-100 position-relative">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title"{{ t_content('pages.contact') }}/h5>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card page-card h-100 position-relative">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title"{{ t_content('pages.terms_of_service') }}/h5>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="card page-card h-100 position-relative">
                    ...
                    <div class="card-body text-center">
                        ...
                        <h5 class="card-title"{{ t_content('pages.privacy_policy') }}/h5>
