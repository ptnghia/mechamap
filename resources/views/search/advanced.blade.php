        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="search-box">
                    ...
                    <form id="search-form" action="{{ route('threads.index') }}" method="GET">
                    ...
                    <div class="popular-searches">
                        ...
                        <a href="{{ route('threads.index', ['search' => 'máy tiện CNC']) }}" class="popular-search-item">máy tiện CNC</a>
                        <a href="{{ route('threads.index', ['search' => 'động cơ servo']) }}" class="popular-search-item">động cơ servo</a>
                        <a href="{{ route('threads.index', ['search' => 'bearing SKF']) }}" class="popular-search-item">bearing SKF</a>
                        <a href="{{ route('threads.index', ['search' => 'thép không gỉ']) }}" class="popular-search-item">thép không gỉ</a>
                        <a href="{{ route('threads.index', ['search' => 'máy phay']) }}" class="popular-search-item">máy phay</a>
                    </div>
                    @endif
                </div>
            </div>
