                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="filtersDropdown">
                                ...
                                <li><a class="dropdown-item" href="{{ route('conversations.index', ['filter' => 'unread']) }}">Unread only</a></li>
                                <li><a class="dropdown-item" href="{{ route('conversations.index', ['filter' => 'started']) }}">Started by me</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    @if($conversations->count() > 0)
                        <div class="list-group list-group-flush">
                            @foreach($conversations as $conversation)
                                <a href="{{ route('conversations.show', $conversation) }}" class="list-group-item list-group-item-action py-3 px-3 {{ $conversation->hasUnreadMessages(Auth::id()) ? 'bg-light' : '' }}">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h6 class="mb-1 d-flex align-items-center">
                                                    ...
                                                    <span class="{{ $conversation->hasUnreadMessages(Auth::id()) ? 'fw-bold' : '' }}">{{ $otherParticipant->name ?? $conversation->title ?? __('Conversation') }}</span>
                                                </h6>
                                                <p class="mb-1 text-truncate" style="max-width: 500px;">
                                                    @if($conversation->lastMessage && $conversation->lastMessage->user_id == Auth::id())
                ...
                <form action="{{ route('conversations.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" class="form-control" placeholder="{{ __('Conversation title...') }}">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="allow_invite" id="allow_invite" value="1">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="lock_conversation" id="lock_conversation" value="1">
