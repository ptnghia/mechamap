                ...
                <div class="card-body">
                    <form action="{{ route('threads.update', $thread) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('location') is-invalid @enderror" id="location" name="location" value="{{ old('location', $thread->location) }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control @error('usage') is-invalid @enderror" id="usage" name="usage" value="{{ old('usage', $thread->usage) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control @error('floors') is-invalid @enderror" id="floors" name="floors" value="{{ old('floors', $thread->floors) }}" min="1">
                                        @error('floors')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status">
                                            ...
                                            <option value="Under Construction" {{ old('status', $thread->status) == 'Under Construction' ? 'selected' : '' }}>Under Construction (E/C)</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="card h-100">
                                        <img src="{{ asset('storage/' . $media->path) }}" class="card-img-top" style="height: 150px; object-fit: cover;">
                                        <div class="card-body p-2">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" name="delete_images[]" value="{{ $media->id }}" id="delete-image-{{ $media->id }}">
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                            <a href="{{ route('threads.show', $thread) }}" class="btn btn-outline-secondary me-md-2">Cancel</a>
