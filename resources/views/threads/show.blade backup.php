        ...
        <div class="detail_thread_body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="thread-actions d-flex gap-2 align-items-center">
                    ...
                    <a href="#comment-{{ $comments->count() > 0 ? $comments->last()->id : '' }}" class="btn btn-outline-primary btn-sm">
                        <i class="fas fa-arrow-down me-1"></i> {{ __('thread.go_to_end') }}
                    </a>
                </div>
            </div>
                    ...
                    <div class="comment_item_body">
                        ...
                        <div class="comment_item_meta d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                @can('update', $comment)
                                <div class="btn-group ms-2">
                                    <button class="btn btn-sm btn-primary active edit-comment-button" data-comment-id="{{ $comment->id }}" data-comment-content="{{ $comment->content }}">
                                        <i class="fas fa-edit me-1"></i>
                                    </button>
                                    <button type="button" class="btn btn-sm btn-danger delete-comment-btn" data-comment-id="{{ $comment->id }}" data-comment-type="comment" title="{{ __('thread.delete_comment') }}">
...
function initializeEventHandlers() {
    ...
    function setFormEditMode(commentId, content) {
        ...
        // Change form action and method for edit
    ...
    function resetFormToReplyMode() {
        ...
        form.action = '{{ route('threads.comments.store', $thread) }}';
