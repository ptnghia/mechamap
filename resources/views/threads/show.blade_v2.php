                        ...
                        <div class="d-flex">
                            ...
                            <div class="comment_item_body">
                                ...
                                <div class="inline-edit-form" id="edit-form-{{ $comment->id }}" style="display: none;">
                                    <form class="comment-edit-form" data-comment-id="{{ $comment->id }}" enctype="multipart/form-data">
                                        @csrf
...
@endauth
<script>
// Nếu phía trên có script khác, đảm bảo kết thúc bằng dấu ; trước khi bắt đầu block này.
...
$config = [
    ...
    'userId' => auth()->id(),
    'userAvatar' => auth()->check() ? auth()->user()->getAvatarUrl() : null,
    'scrollToCommentId' => session('scroll_to_comment'),
    'csrf' => csrf_token(),
    'routes' => [
        'commentStore'       => route('threads.comments.store', $thread),
        'commentLike'        => '/comments/{id}/like',
        'commentDelete'      => '/comments/{id}',
        'commentImageDelete' => '/comments/{comment_id}/images/{image_id}',
        'threadLike'         => "/threads/{$thread->slug}/like",
        'threadSave'         => "/threads/{$thread->slug}/save",
    ],
    'i18n' => [
        'like'                     => __('thread.like'),
        'unlike'                   => __('thread.unlike'),
        'reply'                    => __('thread.reply'),
        'quote'                    => __('thread.quote'),
        'edit'                     => __('thread.edit'),
        'delete'                   => __('thread.delete'),
        'sending'                  => __('thread.sending'),
        'send_reply'               => __('thread.send_reply'),
        'reply_required'           => __('thread.reply_content_required'),
        'comment_updated'          => __('thread.comment_updated_successfully'),
        'comment_deleted'          => __('thread.comment_deleted_successfully'),
        'error'                    => __('thread.error_occurred'),
        'request_error'            => __('thread.request_error'),
        'delete_comment_confirm'   => __('features.threads.delete_comment_message'),
        'delete_reply_confirm'     => __('features.threads.delete_reply_message'),
        'delete_image_confirm'     => __('ui.confirmations.delete_image'),
        'processing'               => __('ui.status.processing'),
        'login_to_like'            => __('thread.login_to_like'),
        'login_to_save'            => __('thread.login_to_save'),
        'saved'                    => __('ui.actions.saved'),
        'save'                     => __('ui.actions.save'),
        'unsave'                   => __('thread.unsave'),
        'reply_posted_successfully'=> __('thread.reply_posted_successfully'),
        'reply_posting_error'      => __('thread.reply_posting_error'),
    ],
];
@endphp

window.ThreadPageConfig = @js($config);
</script>
