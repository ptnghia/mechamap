...
(function($) {
    ...
    // Feather Icons removed - using Font Awesome instead
    function initFeathericon() {
        // Disabled - using Font Awesome
        console.log('Feather Icons disabled in app.min.js - using Font Awesome');
    }
    ...
    function init() {
        ...
        initSettings();
        initLanguage();
        // initFeathericon(); // Disabled - using Font Awesome
        initPreloader();
        layoutSetting();
        Waves.init();
        initCheckAll();
