            ...
            <div class="row mb-4">
                <div class="col-md-12">
                    <div class="card shadow-sm rounded-3">
                        <div class="card-body">
                            <h3 class="text-center mb-4">{{ __('Choose the Right Service for Your Business') }}</h3>
                            <p class="text-center mb-5">{{ __('We offer a range of services designed to help businesses of all sizes grow and succeed.') }}</p>
                                    ...
                                    <div class="col-md-6 col-lg-3 mb-4">
                                        <div class="card h-100 shadow-sm">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <a href="{{ route('subscription.index') }}" class="btn btn-outline-primary mt-auto">{{ __('Get Started') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                            {{ __('How do premium listings work?') }}
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingTwo">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                            {{ __('Can I cancel my subscription at any time?') }}
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingThree">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                            {{ __('What kind of analytics will I receive?') }}
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingFour">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                            {{ __('Do you offer custom packages for larger businesses?') }}
                                        </button>
                                    </h2>
