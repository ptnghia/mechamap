...
// Analyze subscription/index.blade.php for translation issues
$file = 'D:/xampp/htdocs/laravel/mechamap_backend/resources/views/subscription/index.blade.php';

echo "📍 DETAILED ANALYSIS: subscription/index.blade.php\n";
echo "==========================================================\n\n";
...
foreach ($files as $langFile) {
    ...
    if (is_array($translations)) {
        ...
        echo "✅ Loaded: $namespace.php (" . count($translations) . " keys)\n";
    } else {
        echo "❌ Failed to load: $namespace.php\n";
    }
}
