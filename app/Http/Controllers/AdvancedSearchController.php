...
class AdvancedSearchController extends Controller
{
    ...
    // Legacy ajaxSearch method removed - now using /api/v1/search/unified
    ...
    // Legacy fallbackAjaxSearch method removed - now using unified search API

    // Legacy formatAjaxResults method removed - now using unified search API
