...
class ProductController extends Controller
{
    ...
    public function create(): View
    {
        ...
        // Get allowed product types for supplier
        ...
        return view('supplier.products.create', compact('categories', 'seller', 'allowedTypes'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $product = MarketplaceProduct::create([
            ...
            'status' => 'pending', // Supplier products require approval
            'is_active' => false,
        ]);
