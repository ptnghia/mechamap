...
class FaqController extends Controller
{
    ...
    public function bulkActivate(Request $request)
    {
        ...
        $count = Faq::whereIn('id', $ids)->update(['is_active' => true]);

        return redirect()->back()->with('success', "Đã kích hoạt {$count} câu hỏi thành công.");
    }

    /**
     * Bulk deactivate FAQs
     */
    public function bulkDeactivate(Request $request)
    {
        ...
        $count = Faq::whereIn('id', $ids)->update(['is_active' => false]);

        return redirect()->back()->with('success', "Đã vô hiệu hóa {$count} câu hỏi thành công.");
    }
    ...
    public function bulkDelete(Request $request)
    {
        ...
        $count = Faq::whereIn('id', $ids)->count();
        Faq::whereIn('id', $ids)->delete();

        return redirect()->back()->with('success', "Đã xóa {$count} câu hỏi thành công.");
    }
